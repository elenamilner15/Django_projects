...
class Rental(models.Model):
    ...
    def __str__(self):
            return f"{self.rental_date} - {self.customer} - {self.vehicle}"
...
class AddressStation(models.Model):
    address=models.CharField(max_length=100)
...
class RentalStation(models.Model):
    ...
    address=models.ForeignKey(AddressStation, on_delete=models.CASCADE)
...
class VehicleAtRentalStation(models.Model):
    ...
    def __str__(self):
        return f"{self.vehicle} at {self.rental_station} {self.arrival_date}"
